...
export default function Header() {
  return (
    <div
      className="flex flex-col items-center justify-center space-y-8 border-b bg-slate-100 p-10 shadow lg:fixed lg:inset-y-0 lg:w-96 lg:justify-start lg:border-b-0 lg:border-r">
